class Song < ActiveRecord::Base
  ...
  def drake_made_this
    ...
    #The update method is then called on the current song object, passing in the artist attribute and the drake object as its value, which updates the artist of the song to Drake.
